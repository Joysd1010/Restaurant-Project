...
const AboutUs = () => {
  ...
  return (
    <div className="md:mx-28 mx-5">
      ...
      <h1 className="text-Charcoal font-bold text-26 py-5 md:py-10 text-center">
        Contact Us
      </h1>
      <hr className="border-2 md:mx-20 border-limeGreen mb-6" />
        ...
        <div className="flex gap-10 mx-7 md:mx-64">
          <div className="rounded-full border-2 hover:border-limeGreen py-10 w-40 md:w-60 text-center">
            ...
            <a
              ...
              className="cursor-pointer font-merriweather hover:scale-105 transition-transform duration-300"
            >
              +447473198598
            </a>
          </div>
          <div className="rounded-full border-2 hover:border-limeGreen py-10 w-40 md:w-60 text-center">
            ...
            <a
              ...
              className="cursor-pointer hover:scale-105 transition-transform duration-300 font-merriweather px-3"
            >
      ...
      <div className="flex justify-around py-5">
        <div className="flex gap-10">
          <div className="p-2 rounded-full border-2 hover:border-limeGreen">
            <Link to="#"><FaFacebook size={80} /></Link>
          </div>
          <div className="p-2 rounded-full border-2 hover:border-limeGreen">
            <Link to="#"><FaXTwitter size={80} /></Link>
          </div>
          <div className="p-2 rounded-full border-2 hover:border-limeGreen">
            <Link to="#"><FaInstagram size={80} /></Link>
          </div>
        </div>
      </div>
      <iframe
        ...
        className="mx-auto py-5 md:w-[1100px] w-[300px] h-[300px]"
      />
    </div>
  );
};
