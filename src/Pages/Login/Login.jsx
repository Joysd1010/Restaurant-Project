...
const Login = () => {
  ...
  return (
    <div className="md:mx-32 flex flex-col md:flex-row items-center py-5 md:py-10">
      <Helmet>
        <title>Login - Olive&lime</title>
        <meta
          name="description"
          content="Login to the Olive&Lime admin panel and manage your restaurant's operations, including reservations, menu updates, and staff scheduling."
        />

        <link rel="canonical" href="https://oliveandlime.co.uk/login" />
      </Helmet>
      <div>
        <img
          src="https://i.postimg.cc/g0qH0MtC/Untitled-design.gif"
          className=" md:w-[500px]"
          alt=""
        />
      </div>
      <div className="flex flex-col gap-2 border-2 hover:border-olive md:w-96 px-10 py-5 rounded-xl">
        <h1 className="text-3xl text-darkOlive mb-10 text-center">
          Login Here!!
        </h1>
